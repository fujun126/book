...
public class ReaderRankingListUI extends JFrame{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private JLabel jl = new JLabel("读者借阅排行信息", JLabel.CENTER);
	...
	public ReaderRankingListUI(){
		this.setTitle("读者借阅排行信息");
	...
	public void setTableData(){
		...
		List<Bookinfo> list = dao.readerList();
